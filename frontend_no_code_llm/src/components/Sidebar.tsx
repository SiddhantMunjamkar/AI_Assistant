...
import { ChevronLeft, ChevronRight, Laptop, Settings, Users, ChevronDown } from "lucide-react"
            ...
            <div className="space-y-1">
              ...
              <nav className="space-y-1">
                ...
                >
                  ...
                  {!isCollapsed && <span className="ml-2 transition-all duration-300 ease-in-out">Dashboard</span>}
                </NavLink>
                <NavLink
                  to="/users"
                  className={({ isActive }: { isActive: boolean }) =>
                ...
                > */}
                  ...
                  {!isCollapsed && <span className="ml-2 transition-all duration-300 ease-in-out">Settings</span>}
                </NavLink>
              </nav>
            </div>
          </div>
          <div className="px-3">
            ...
            >
              <div className="flex items-center justify-between py-2">
                <h2 className={cn(
                  "px-4 text-sm font-semibold tracking-tight",
                  isCollapsed ? "opacity-0" : "opacity-100"
                )}>
                 History
                </h2>
